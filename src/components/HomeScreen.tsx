...
export function HomeScreen({ onStartSession }: HomeScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-warm-gradient px-4 py-6 pb-24 md:px-6 md:pb-10">
      <div className="mx-auto w-full max-w-md xl:max-w-7xl animate-fade-in">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 xl:items-start">
          <div className="xl:col-span-5 xl:order-2 xl:sticky xl:top-24 space-y-6">
            {/* Notes from Past You */}
          ...
          <div className="xl:col-span-7 xl:order-1">
            <div className="xl:card-elevated xl:border xl:border-border/70 xl:p-6">
              {/* Greeting */}
          ...
          {recentTemplates.length > 0 && (
            <div className="xl:col-span-5 xl:order-3">
